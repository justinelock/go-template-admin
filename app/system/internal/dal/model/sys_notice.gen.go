...
type SysNotice struct {
	NoticeID      string    `gorm:"column:notice_id;primaryKey;comment:公告ID" json:"notice_id"`            // 公告ID
	...
	NoticeContent []byte    `gorm:"column:notice_content;comment:公告内容" json:"notice_content"`             // 公告内容
	Status        string    `gorm:"column:status;default:0;comment:公告状态（0正常 1关闭）" json:"status"`          // 公告状态（0正常 1关闭）
